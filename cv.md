...
<div class="basics-grid">
  ...
  <div class="basic-row">
    ...
    <span class="basic-value">Development of a 12–20 GHz radio astronomical receiver for high z CO line-intensity mapping</span>
  </div>
</div>
...
<div class="publication-item grid">
  ...
  <!-- 오른쪽 칸: 날짜, (선택) 위치 -->
  <div class="publication-meta">
    <div class="publication-date">Nov, 2025</div>
    <!-- 만약 장소를 표시하고 싶다면 아래 줄을 추가 -->
    <!-- <div class="publication-location">📍 Daejeon, South Korea</div> -->
  </div>
</div>
...
<div class="honor-item grid">
  ...
  <div class="honor-info">
    <div class="honor-title">2025 석사과정생연구장려금</div>
    <div class="honor-institution">National Research Foundation of Korea</div>
  </div>
  <!-- 오른쪽 칸: 날짜 -->
