...
## Current Projects
1. 12–20 GHz receiver development for carbon monoxide line-intensity mapping Targeting z > 4.8 in COMAP-EoR project.
2. Wideband quantum noise limited readout based on Josephson parametric amplifiers for axion haloscope experiments.

</div>

<div class="about-image"> <img src="{{ '/assets/gallery/2025_ovro_milkyway.png' | relative_url }}" alt="My Photo" /> </div>
